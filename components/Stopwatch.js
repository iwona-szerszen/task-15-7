class Stopwatch extends React.Component {
	...
	saveTime() {
		const results = [...this.state.results, this.format()];
		...
		return (
			<div>
				<nav className="controls">
					...
					<a href="#" onClick={this.resetTimer.bind(this)}>Reset</a>
				</nav>
				<div className="stopwatch">
					{this.format()}
				</div>
				<nav className="list-header">
					<a href="#" className="reset-results" onClick={this.resetResults.bind(this)}>Reset list</a>
